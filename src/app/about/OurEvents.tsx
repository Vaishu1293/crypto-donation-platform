...
import VolunteerModal from "./join-as-volunteer";
...
export default function OurEvents() {
  ...
  return (
    <>
      <section className="w-full py-20 px-6 md:px-20 bg-white flex flex-col gap-20 relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            ...
            <div className="flex gap-4 mt-6">
              <button
                ...
                className="bg-[#FAD048] text-black font-semibold py-2 px-6 rounded-md text-sm"
              >
                Join as a volunteer
              </button>
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[{ date: "13", month: "APR", title: "A day with our wonderful children", link: "#" },
              { date: "25", month: "APR", title: "Seminar: Caring for children with autism", link: "#" }
            ].map((event, index) => (
